...
export function Steps() {
  return (
    <div className="relative">
      ...
      <div className="hidden lg:block absolute top-12 left-[12%] right-[12%] h-0.5 bg-gradient-to-r from-slate-200 via-primary/20 to-slate-200 -z-10" />
        ...
        {steps.map((item, i) => (
          <div key={i} className="relative group">
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-primary/20 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col items-center text-center relative z-10">
              ...
              {/* Icon */}
              <div className="w-16 h-16 rounded-2xl bg-slate-50 group-hover:bg-primary/5 border border-slate-100 group-hover:border-primary/10 flex items-center justify-center mb-5 transition-colors duration-300">
